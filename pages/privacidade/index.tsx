   ...
   return (
      <>
         ...
         <PageHero
            ...
            subtitle="Suas informações estarão seguras conosco."
            img="/img/water.jpg"
         />
         <main className="bg-why-gray-50 py-16">
            <div className="container px-4 max-w-5xl mx-auto text-justify">
               <p className="text-why-gray-800">
                  A sua privacidade é importante para nós. É política do Brasil
                  Travel Club respeitar a sua privacidade em relação a qualquer
                  informação sua que possamos coletar no site Brasil Travel
                  Club, e outros sites que possuímos e operamos
               </p>
               <p className="text-why-gray-800">
               ...
               <p className="text-why-gray-800 mt-3">
               ...
               <ul className="text-why-gray-800 my-2 list-inside list-disc space-y-2">
                  <li>
                     O serviço Google AdSense que usamos para veicular
                     publicidade usa um cookie DoubleClick para veicular
                     anúncios mais relevantes em toda a Web e limitar o número
                  ...
                  <li>
                     ...
                     garantir que você forneça os anúncios mais relevantes
                     sempre que possível, rastreando anonimamente seus
                     interesses e apresentando coisas semelhantes que possam ser
                     do seu interesse.
                  </li>
                  <li>
               ...
               <p className="text-why-gray-800">
                  ...
                  da informação que o Brasil Travel Club oferece no site e com
               ...
               <p className="text-why-gray-800 mt-3">
                  Esta política é efetiva a partir de 4 November 2023 12:50
               </p>
            </div>
         </main>
         <Footer />
