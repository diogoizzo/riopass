            ...
            <div className="container mx-auto px-4">
               <div className="max-w-2xl mx-auto text-center">
                  ...
                  <h1 className="text-4xl mt-10 font-bold mb-6 text-why-gray-900">
                     Vem ai uma nova forma de economizar em suas viagens.
                  </h1>
               ...
               <div className="flex flex-wrap -mx-4 mt-12">
                  <div className="w-full md:w-1/3 px-4 mb-8">
                     <div className="rounded-md bg-why-blue-600 shadow-md p-8">
                        ...
                        <p className=" mb-4 text-why-gray-200">
                           O travel club terá um preço único, que você vai pagar
                           um única vez e vai receber um cupom que te dará
                           desconto em dezenas de atrações, sem limite de
                           utilização.
                        </p>
                     </div>
                  </div>
                  <div className="w-full md:w-1/3 px-4 mb-8">
                     <div className="rounded-md bg-why-blue-600 shadow-md p-8">
                        ...
                        <p className=" text-why-gray-200 mb-4">
                           ...
                           descontos em todas as atrações dos nossos parceiros,
                           e pode utilizar esse descontos quantas vezes quiser.
                        </p>
                     </div>
                  </div>
                  ...
                  <div className="w-full md:w-1/3 px-4 mb-8">
                     <div className="rounded-md bg-why-blue-600  shadow-md p-8">
                        ...
                        <p className="text-why-gray-200 mb-4">
                           Ao utilizar o travel club nos faremos a sua reserva
                           na atração desejada, basta solicitar pelo site ou
                           whatsapp e aguardar a confirmação da sua reserva.
                        </p>
                     </div>
                  </div>
               </div>
