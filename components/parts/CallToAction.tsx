...
function CallToAction() {
   return (
      <div className="mt-3 relative bg-why-blue-600 rounded-md shadow-md  p-4 text-center text-why-gray-100">
         ...
         <h2 className="text-3xl  font-semibold text-why-yellow-400">
            e economize em sua viagem
         </h2>
         <p className="text-xl mt-4 mb-3 text-why-gray-200">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Deleniti
            quia qui commodi odit porro, error nisi cupiditate optio voluptas
            provident ducimus
         </p>
         <p className="mb-12 text-lg text-gray-300">
            <span className="block text-3xl font-medium">De R$199,00</span> por
            apenas
            <span className="block text-6xl font-bold text-why-yellow-600 text-shadow-light">
               R$120,00
            </span>
         </p>
