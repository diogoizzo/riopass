...
function PageHero({
   ...
   return (
      <section
         className={`w-full py-52 md:py-64 text-center relative    bg-cover bg-center`}
         style={{ backgroundImage: `url("${img}")` }}
      >
         <div className="w-full bg-white absolute tracking-wider font-medium bg-gradient-to-r from-why-yellow-400 via-why-green-500 to-why-blue-400 shadow-md shadow-black/30 text-why-gray-50 text-xl py-6 top-[5rem]">
         ...
         <div className="absolute -bottom-8 left-1/2 transform -translate-x-1/2 bg-why-gray-50 rounded-xl py-6 text-why-blue-900 underline underline-offset-[1rem] decoration-2 px-6 font-semibold text-3xl w-[80%]">
            <p className="w-full">
